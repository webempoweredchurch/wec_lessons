...
class tx_weclesson_realurl {
	...
	function addPostVarSets() {
		...
		$postVarSets['lesson'] = array(
			$this->addTable('tx_weclesson_pi1[lsn]', 'tx_weclesson_lesson'),
		);
		return $postVarSets;
	}
	 ...
	 *
	 *	array( 'GETvar' => 'tx_weclesson_pi1[f1]' ),
	 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wec_lesson/hooks/class.tx_weclesson_realurl.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wec_lesson/hooks/class.tx_weclesson_realurl.php']);
}
?>